import type { TimelineGroup, ToolRound } from '../runs'
import type { RunEvent } from '../runs/runEvents'
import { TextAttributes } from '@opentui/core'
import { foldToolEvents, groupTimeline } from '../runs'
...
function formatInputValue(value: unknown): string {
  if (typeof value === 'string')
    return truncate(value, INPUT_VALUE_LIMIT)
...
function groupStatus(rounds: ToolRound[]): { text: string, color: string } {
  ...
  if (rounds.some(r => r.isError))
    return { text: '✗ Error', color: themeColors.error }
