...
function subscribe(milliseconds: number, subscriber: Subscriber) {
...
function unsubscribe(milliseconds: number, subscriber: Subscriber) {
...
export function useAnimation(rate: number | { intervalMs: number } = 12): number {
