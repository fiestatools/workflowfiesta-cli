import type { AccessTokenRevealEvent, ChatMessageEvent, CredentialRequestEvent, McpSetupEvent, OAuthRequestEvent, RunCompletedEvent, RunEvent, RunnerApprovalPendingEvent, RunnerApprovalResolvedEvent } from './runEvents'
...
export class RunStream {
  ...
  private scheduleReconnect(): void {
    ...
    const delay = Math.min(
      BASE_RECONNECTION_DELAY_MS * 1.5 ** this.retryAttempts,
