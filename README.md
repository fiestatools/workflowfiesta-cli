...
On first run, you'll be prompted to authenticate. Use `wf auth login` for browser-based sign-in, or `wf auth login --token <your-token>` to sign in with an access token.
